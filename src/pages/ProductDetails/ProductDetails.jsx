            ...
            <div>
              ...
              <div className="mt-3 inline-flex items-center rounded-full border border-slate-200">
                ...
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-r-full text-[#0F172A] transition hover:bg-[#EFF6FF] disabled:cursor-not-allowed disabled:opacity-40"
                >
